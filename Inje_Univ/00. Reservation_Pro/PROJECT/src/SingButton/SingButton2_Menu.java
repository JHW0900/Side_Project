...
public class SingButton2_Menu extends JPanel{
	...
	// 메뉴
	ImageIcon example = new ImageIcon("./menu_image/텐텐 메뉴.png");
	...
	public void SingButton2Listener() {
		...
		reservation.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				win.setService(1011, 25);
			}
		});
	}
	
	public SingButton2_Menu(MainPage win)
	{
		this.win = win;
		setLayout(null);
