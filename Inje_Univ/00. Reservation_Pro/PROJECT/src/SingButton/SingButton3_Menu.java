...
public class SingButton3_Menu extends JPanel{
	...
	// 메뉴
	ImageIcon example = new ImageIcon("./menu_image/힐튼 메뉴.png");
	...
	public void SingButton3Listener() {
		...
		reservation.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				win.setService(1012, 20);
			}
		});
	}
	
	public SingButton3_Menu(MainPage win)
	{
		this.win = win;
		setLayout(null);
