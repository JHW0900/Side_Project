...
public class SingButton3_Picture extends JPanel{
	...
	// 사진
	ImageIcon image2 = new ImageIcon("./sing_picture/힐튼코인노래연습장1.jpg");
	...
	ImageIcon image3 = new ImageIcon("./sing_picture/힐튼코인노래연습장2.jpg");
	...
	ImageIcon image4 = new ImageIcon("./sing_picture/힐튼코인노래연습장3.jpg");
	...
	public SingButton3_Picture(MainPage win)
	{
		this.win = win;
		setLayout(null);
