...
public class SingButton2_Information extends JPanel{
	private MainPage win;

	JPanel screen = new JPanel();
	
	// main page에 나오는 사진 
	ImageIcon image1 = new ImageIcon("./sing_picture/텐텐 동전 노래방.jpg");
	...
	JLabel sing_name = new JLabel("텐텐 동전 노래방");
	JLabel sing_review = new JLabel("평점 : 4.25");
	...
	// 정보
	JLabel time = new JLabel("운영시간 : 매일 11:00 ~ 01:00");
	JLabel holiday = new JLabel("휴무일    : 연중무휴");
	JLabel phone = new JLabel("전화번호 :  X");
	JLabel location = new JLabel("위치정보 : 경남 김해시 인제로188번길 10 금호빌딩");
	JLabel introduce = new JLabel("<html>가게소개 : #김해동전노래방 #김해코인노래방 #인제대<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;#인제대텐텐노래방"
								+ "<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;#인제대에서놀기 #인제대가성비놀이</html>");
	...
	public SingButton2_Information(MainPage win)
	{
		this.win = win;
		setLayout(null);
