...
public class StudyButton3_Menu extends JPanel{
	...
	// 메뉴
	ImageIcon example = new ImageIcon("./menu_image/지니 메뉴.png");
	...
	public void StudyButton3Listener() {
		...
		reservation.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				win.setService(1008, 25);
			}
		});
	}
	
	public StudyButton3_Menu(MainPage win)
	{
		this.win = win;
		setLayout(null);
