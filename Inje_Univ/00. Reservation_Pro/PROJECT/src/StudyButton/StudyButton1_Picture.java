...
public class StudyButton1_Picture extends JPanel{
	...
	// 사진
	ImageIcon image2 = new ImageIcon("./study_picture/공부의신 독서실1.jpg");
	...
	ImageIcon image3 = new ImageIcon("./study_picture/공부의신 독서실2.jpg");
	...
	ImageIcon image4 = new ImageIcon("./study_picture/공부의신 독서실3.jpg");
	...
	public StudyButton1_Picture(MainPage win)
	{
		this.win = win;
		setLayout(null);
