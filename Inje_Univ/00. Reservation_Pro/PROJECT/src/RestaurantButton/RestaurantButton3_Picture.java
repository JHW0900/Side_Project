...
public class RestaurantButton3_Picture extends JPanel{
	...
	// 사진
	ImageIcon image2 = new ImageIcon("./restaurant_picture/청년다방 인제대점1.jpg");
	...
	ImageIcon image3 = new ImageIcon("./restaurant_picture/청년다방 인제대점2.jpg");
	...
	ImageIcon image4 = new ImageIcon("./restaurant_picture/청년다방 인제대점3.jpg");
	...
	public RestaurantButton3_Picture(MainPage win)
	{
		this.win = win;
		setLayout(null);
