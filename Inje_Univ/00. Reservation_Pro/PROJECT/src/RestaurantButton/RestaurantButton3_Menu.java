...
public class RestaurantButton3_Menu extends JPanel{
	...
	// 메뉴
	ImageIcon example = new ImageIcon("./menu_image/청년 메뉴.png");
	...
	public void RestaurantButton3Listener() {
		...
		reservation.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				win.setService(1003, 24);
			}
		});
	}
	
	
	public RestaurantButton3_Menu(MainPage win)
	{
		this.win = win;
		setLayout(null);
