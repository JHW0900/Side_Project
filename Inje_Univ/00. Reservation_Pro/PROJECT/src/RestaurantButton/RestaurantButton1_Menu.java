...
public class RestaurantButton1_Menu extends JPanel{
	...
	// 메뉴
	ImageIcon example = new ImageIcon("./menu_image/코이 메뉴.png");
	...
	public void RestaurantButton1Listener() {
		...
		reservation.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				win.setService(1004, 13);
			}
		});
	}
	
	public RestaurantButton1_Menu(MainPage win)
	{
		this.win = win;
		setLayout(null);
