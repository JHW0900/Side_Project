...
public class RestaurantButton4_Menu extends JPanel{
	...
	// 메뉴
	ImageIcon example = new ImageIcon("./menu_image/롯데 메뉴.png");
	...
	public void RestaurantButton4Listener() {
		...
		reservation.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				win.setService(1001, 25);
			}
		});
	}
	
	public RestaurantButton4_Menu(MainPage win)
	{
		this.win = win;
		setLayout(null);
