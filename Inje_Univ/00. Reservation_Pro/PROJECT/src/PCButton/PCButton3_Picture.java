...
public class PCButton3_Picture extends JPanel{
	...
	// 사진
	ImageIcon image2 = new ImageIcon("./pc_picture/인싸이더pc카페 1호점1.jpg");
	...
	ImageIcon image3 = new ImageIcon("./pc_picture/인싸이더pc카페 1호점2.jpg");
	...
	ImageIcon image4 = new ImageIcon("./pc_picture/인싸이더pc카페 1호점3.jpg");
	...
	public PCButton3_Picture(MainPage win)
	{
		this.win = win;
		setLayout(null);
