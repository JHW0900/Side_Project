...
public class PCButton2_Picture extends JPanel{
	...
	// 사진
	ImageIcon image2 = new ImageIcon("./pc_picture/인스타pc카페 인제대점1.jpg");
	...
	ImageIcon image3 = new ImageIcon("./pc_picture/인스타pc카페 인제대점2.jpg");
	...
	ImageIcon image4 = new ImageIcon("./pc_picture/인스타pc카페 인제대점3.jpg");
	...
	public PCButton2_Picture(MainPage win)
	{
		this.win = win;
		setLayout(null);
